...
class DrawBest(ScoreBaseImage):
    def __init__(self, UserInfo: UserInfo_all, qqId: Optional[Union[int, str]] = None) -> None:
        ...
        for i in self.records:
            if (i.achievements<100.0 and i.achievements>=99.95) or (i.achievements<100.5 and i.achievements>=100.45):
...
async def generate_cun(qqid: Optional[int] = None, username: Optional[str] = None) -> str:
    try:
        if username:
            qqid = None
