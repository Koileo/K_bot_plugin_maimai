...
async def generate_2(qqid: Optional[int] = None, username: Optional[str] = None) -> Union[MessageSegment, str]:
    """
    生成b50
    ...
    try:
        if username:
            qqid = None
        userinfo = await maiApi.query_user_b40(qqid=qqid, username=username)
